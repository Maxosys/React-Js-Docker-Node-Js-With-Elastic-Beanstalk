...
handleChange(event) {
  ...
  this.setState({
   ...
   onSetResult = (result) => {
    ...
    forgetPassword(event) {
      ...
      var apiBaseUrl = "/api/forgetpassword";
      var self = this;
      ...
      var respdata =  fetch(apiBaseUrl,{
          ...
          headers: {"Content-Type": "application/json"}
           ...
           .then((json) => {  
              ...
              {
                this.setState({ successmsg: 'Email Id Not Registered',showResults:true })
  ...
  render() {
    ...
    <form className="reset__form" id="reset-form" onSubmit={this.forgetPassword} >
    ...
    <div className="login-section bg-ribbins">
      <div className="container">
        <div className="tab-wrap">
          <h2 className="head-title">Log Into Your Account </h2>
